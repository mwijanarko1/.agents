---
name: gateguard
description: "Force concrete investigation before risky edits or commands."
origin: community
---
...
- Unknown codebases or areas without a recently reviewed `CODEBASE_MAP.md`
- Schema, data model, migration, serialization, or date/format changes
- Public API, event contract, permission, auth, billing, or entitlement changes
